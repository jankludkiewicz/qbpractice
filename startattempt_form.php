...
class block_qbpractice_startattempt_form extends moodleform {
    ...
    public function definition() {
		...
		$mform->addElement('html', '<label class="studypreference-label"><input type="radio" name="studypreference" class="studypreference-radio" value="0">');
		$mform->addElement('html', 'All questions</label>');
		$mform->addElement('html', '<label class="studypreference-label"><input type="radio" name="studypreference" class="studypreference-radio" value="1">');
		$mform->addElement('html', 'Flagged only</label>');
		$mform->addElement('html', '<label class="studypreference-label"><input type="radio" name="studypreference" class="studypreference-radio" value="2">');
		$mform->addElement('html', 'Unseen before</label>');
		$mform->addElement('html', '<label class="studypreference-label"><input type="radio" name="studypreference" class="studypreference-radio" value="3">');
		$mform->addElement('html', 'Answered incorrectly</label>');
		$mform->addElement('html', '<label class="studypreference-label"><input type="radio" name="studypreference" class="studypreference-radio" value="4">');
